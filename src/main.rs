    ...
    T: cpal::Sample,
{
    ...
    let hz = 240.0;
    let c = dc(hz) >> pluck(hz, 0.05, 0.9) >> resonator_hz(hz + 5.0, 1.0);

    // let c = dc(110.0) >> dsf_saw_r(0.99);
    //let c = dc(110.0) >> triangle();
    // let c =
    //     lfo(|t| xerp11(20.0, 2000.0, sin_hz(0.1, t))) >> dsf_square_r(0.99) >> lowpole_hz(1000.0);
    ...
    // Bandpass filtering.
    // let c =
    //     c >> (pass() | envelope(|t| xerp(500.0, 20000.0, sin_hz(0.0666, t)))) >> bandpass_q(1.0);
